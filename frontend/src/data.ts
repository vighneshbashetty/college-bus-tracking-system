...
export const routes: Route[] = [
  {
    ...
    color: "#3b82f6",
    stops: [
      { id: "s1", name: "Main Gate (NH-46)", lat: 23.0785, lng: 76.8510, x: 18, y: 82 },
      { id: "s2", name: "Academic Block (AB)", lat: 23.0820, lng: 76.8535, x: 36, y: 64 },
      { id: "s3", name: "Central Library & Admin", lat: 23.0841, lng: 76.8550, x: 52, y: 52 },
      { id: "s4", name: "Food Court & Underbelly", lat: 23.0855, lng: 76.8570, x: 70, y: 44 },
      { id: "s5", name: "Boys Hostel Complex", lat: 23.0875, lng: 76.8595, x: 84, y: 26 },
      { id: "s6", name: "Sports Complex & Ground", lat: 23.0860, lng: 76.8615, x: 60, y: 18 },
      { id: "s7", name: "Girls Hostel Complex", lat: 23.0830, lng: 76.8580, x: 30, y: 32 },
    ],
  },
];
